...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <div
        ...
        <main class="relative">
                ...
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                        <a href="{{ url('/questionnaire') }}"
                            class="px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-black text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
                            Start Assessment
                        </a>
                        <a href="#features"
                            class="px-8 py-4 border-2 border-slate-400 hover:border-white text-slate-300 hover:text-white text-lg font-semibold rounded-xl transition-all duration-300">
                            Learn More
                        </a>
                    </div>
                </div>
            ...
            <!-- Features Section -->
            <div id="features" class="relative bg-white/5 backdrop-blur-sm border-t border-white/10">
                    ...
                    <div class="max-w-6xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-3 gap-8">
                            ...
                            <div
                                ...
                                <div class="w-12 h-12 bg-yellow-400 rounded-lg flex items-center justify-center mb-6">
                    ...
                    <div class="max-w-4xl mx-auto text-center">
                        ...
                        <div class="grid md:grid-cols-3 gap-8">
                            <div class="text-center">
                                <div
                                    class="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-6 text-black text-2xl font-bold">
                                    1
                                </div>
